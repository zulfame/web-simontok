      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
                ...
                $no=1; foreach($tugas as $data)                              
                {
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a href="<?= base_url('remedial/tugas/edit/');?><?= $data->id_st; ?>" class="btn-circle btn-sm btn-warning" title="Ubah"><i class="fa fa-edit"></i></a>

                      <a onclick="return confirm('Klik oke untuk hapus <?= $data->nama_debitur ?>')" class="btn-circle btn-sm btn-danger" href="<?= base_url('tugas/hapus/');?><?= $data->id_st; ?>" title="Hapus Data"><i class="fa fa-trash"></i>
                    </td>
                  </tr>
                <?php }?>
              </tbody>
            ...
            <a href="<?= base_url('remedial/tugas/cetak_harian');?>" target="_blank" class="btn btn-sm btn-success">
