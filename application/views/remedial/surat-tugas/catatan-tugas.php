  ...
  <div class="row">
    ...
    <div class="col-md-9">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form role="form" method="post" action="<?= base_url('remedial/tugas/proses_catatan/');?><?=  $this->uri->segment('4');?>">
            <div class="row">
              <div class="col-md-6">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label>CATATAN</label>
                <textarea class="form-control" name="catatan" required><?= $laporan->catatan;?></textarea>
              </div>
            </div>
