  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-body">
          <form method="get" action="<?php echo base_url("remedial/monitoring/filter/")?>">
          ...
          <div class="form-group pull-right">
            <a href="<?= base_url('remedial/monitoring/data');?>" class="btn btn-primary"><i class="fa fa-bookmark"></i> TAMPIL SEMUA</a>
          </div>
        </div>
      </div>  
    </div>
                ...
                <tr>
                  ...
                  <td class="text-center"><?= $data->tgl_jth_tempo;?></td>
                   <td class="text-center">
                    <a href="<?= base_url('monitoring/histori/');?><?= $data->id_debitur; ?>" target="_blank" class="btn-circle btn-sm btn-warning" title="Riwayat"><i class="fa fa-history"></i></a>
