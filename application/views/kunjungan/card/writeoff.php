        ...
        <div class="box box-<?= $site['line']; ?>">
            <div class="box-header with-border bg-<?= $site['color']; ?>">
                <div class="box-tools pull-left">
                    <a href="<?= base_url('kunjungan/kmd_writeoff'); ?>" class="btn btn-sm btn-default">BACK</a>
                </div>

                <div class="box-tools">
                    <a href="<?= base_url('kunjungan/kmd_card_wo_print/') . $debitur['kd_credit']; ?>" class="btn btn-sm btn-default pull-left"><i class="fa fa-print"></i> PRINT</a>
                </div>
            </div>
                ...
                <div class="row invoice-info">
                    ...
                    <div class="col-sm-4 invoice-col">
                        <table>
                            ...
                            <tr>
                                <td><b>Periode</b></td>
                                <td>&nbsp; : &nbsp; <?= $debitur['jw']; ?> - <?= $debitur['metode_rps']; ?> - <?= $debitur['rate']; ?>%</td>
                            </tr>
                            <tr>
                                <td><b>Previous</b></td>
                                <td>&nbsp; : &nbsp; Rp. <?= rupiah($debitur['os_sebelumnya']); ?></td>
                            </tr>
                            <tr>
                                <td><b>Last OS</b></td>
                                <td>&nbsp; : &nbsp; Rp. <?= rupiah($debitur['os_akhir']); ?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-sm-4 invoice-col">
                        <div class="table-responsive">
                            <table>
                                <tr>
                                    <td><b>Tgk. Bunga</b>&nbsp; : &nbsp; Rp. <?= rupiah($debitur['tgk_bunga']); ?></td>
                                </tr>
                                <tr>
                                    <td><b>Tgk. Denda</b>&nbsp; : &nbsp; Rp. <?= rupiah($debitur['tgk_denda']); ?></td>
                                </tr>
                                <tr>
                                    <td><b>Address :</b></td>
                                </tr>
