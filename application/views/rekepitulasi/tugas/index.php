                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('rekapitulasi/detail_tugas/') .  $r['petugas_code'] . "/" . $_POST['tgl1'] . "/" . $_POST['tgl2']; ?>" class="btn-circle btn-sm btn-success" target="_blank"><i class="fa fa-eye"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
