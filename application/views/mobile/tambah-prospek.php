...
<div class="section full mt-2 mb-2">
    ...
    <div class="wide-block pb-1 pt-2">
        <form action="<?=base_url('prospek/mproses_tambah')?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group boxed">
                <div class="input-wrapper">
                    ...
                    <input type="text" class="form-control" name="calon_debitur">
                    <i class="clear-input">
            ...
            <div class="form-group boxed">
                <div class="input-wrapper">
                    ...
                    <textarea id="address5" rows="2" class="form-control" name="keterangan" required></textarea>
                    <i class="clear-input">
                        <ion-icon name="close-circle"></ion-icon>
                    </i>
                </div>
