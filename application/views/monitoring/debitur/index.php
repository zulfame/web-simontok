        ...
        <div class="box box-<?= $site['line']; ?>">
            <div class="box-header with-border bg-<?= $site['color']; ?>">
                <div class="box-tools pull-left">
                    <a href="<?= base_url('monitoring/export_debitur'); ?>" class="btn btn-sm btn-default">EXPORT</a>
                ...
                <div class="box-tools">
                    <form action="<?= base_url('monitoring/debitur') ?>" method="POST">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= base_url('monitoring/card_print/') . $d['kd_credit']; ?>" class="btn-circle btn-sm btn-primary" target="_blank"><i class="fa fa-print"></i></a>
                                            </td>
                                        </tr>
                                        <?php $page; ?>
                                    <?php endforeach; ?>
