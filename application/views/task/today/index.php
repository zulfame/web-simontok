    ...
    <section class="content">
        ...
        <div class="box box-<?= $site['line']; ?>">
            <div class="box-header with-border bg-<?= $site['color']; ?>">
                ...
                <div class="box-tools">
                    <form action="<?= base_url('task/today') ?>" method="POST">
                                        ...
                                        <div class="modal fade" id="modal-edit<?= $s['id_st']; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?= base_url('task/today_edit'); ?>" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="tgk_pokok" value="<?= $s['tgk_pokok']; ?>">
