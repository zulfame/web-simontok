        ...
        <div class="box box-<?= $site['line']; ?>">
            <div class="box-header with-border bg-<?= $site['color']; ?>">
                <div class="box-tools pull-left">
                    <a href="<?= base_url('task/debitur'); ?>" class="btn btn-sm btn-default">BACK</a>
                </div>

                <div class="box-tools">
                    <a href="<?= base_url('task/card_print/') . $debitur['kd_credit']; ?>" class="btn btn-sm btn-default pull-left"><i class="fa fa-print"></i> PRINT</a>
                </div>
            </div>
