    ...
    <section class="content">
        ...
        <div class="box box-<?= $site['line']; ?>">
            <div class="box-header with-border bg-<?= $site['color']; ?>">
                ...
                <div class="box-tools">
                    <form action="<?= base_url('report/kmd_writeoff') ?>" method="POST">
                                    ...
                                    <?php foreach ($debitur as $d) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('report/kmd_card_wo/') . $d['kd_credit']; ?>" class="btn-circle btn-sm btn-success" target="_blank"><i class="fa fa-file-text"></i></a>
                                                <a href="<?= base_url('report/kmd_card_wo_print/') . $d['kd_credit']; ?>" class="btn-circle btn-sm btn-primary" target="_blank"><i class="fa fa-print"></i></a>
                                            </td>
                                        </tr>
                                        <?php $page; ?>
                                    <?php endforeach; ?>
