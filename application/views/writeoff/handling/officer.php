                                        ...
                                        <div class="modal fade" id="modal-edit<?= $s['id_st']; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?= base_url('writeoff/st_edit_officer'); ?>" method="POST" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="hidden" name="tgk_pokok" value="<?= $s['os_akhir']; ?>">
                                                            <input type="hidden" name="tgk_bunga" value="<?= $s['tgk_bunga']; ?>">
                                                            <input type="hidden" name="tgk_denda" value="<?= $s['tgk_denda']; ?>">
                                                            ...
                                                            <div class="form-grup">
                                                                <label>Note</label>
                                                                <textarea class="form-control" readonly><?= $s['catatan'] ?></textarea>
                                                            </div>
