        ...
        <div class="box box-<?= $site['line']; ?>">
            <div class="box-header with-border bg-<?= $site['color']; ?>">
                <div class="box-tools pull-left">
                    <a data-toggle="modal" data-target="#modal-tambah-wo" class="btn btn-sm btn-default">WRITEOFF</a>
                ...
                <div class="box-tools">
                    <form action="<?= base_url('writeoff/st') ?>" method="POST">
            ...
            <div class="box-body" style="margin-top:-5px ;">
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= base_url('writeoff/st_delete') ?>/<?= $s['id_st']; ?>" class="btn-circle btn-sm btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content" style="border-radius: 10px;">
                                                    <div class="modal-body">
                                                        <img class="img-responsive" src="<?= base_url('assets/img/st_wo/'); ?><?= $s['image']; ?>" style="border-radius: 10px;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal fade" id="modal-edit<?= $s['id_st']; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?= base_url('writeoff/st_edit'); ?>" method="POST">
                                                        <div class="modal-body">
                                                                ...
                                                                <select class="form-control" style="width: 100%;" name="debitur_code" id="select2" required>
                                                                    ...
                                                                    <?php foreach ($debitur_wo as $d) : ?>
                                                                        <?php if ($d['kd_credit'] == $s['kd_credit']) : ?>
                                                                            <option value="<?= $d['kd_credit']; ?>" selected><?= $d['nama_debitur']; ?> - <?= $d['kd_petugas']; ?></option>
                                                                        <?php else : ?>
                                                                            <option value="<?= $d['kd_credit']; ?>"><?= $d['nama_debitur']; ?> - <?= $d['kd_petugas']; ?></option>
                                                                        <?php endif; ?>
                                                                    <?php endforeach; ?>
                                                                </select>
                                                            </div>
                        ...
                        <!-- Pagination -->
                        <a href="<?= base_url('writeoff/st_print'); ?>" class="btn btn-sm btn-primary" target="_blank"><i class="fa fa-print"></i>&nbsp; REPORT</a>
                        <a href="<?= base_url('writeoff/st_print_officer'); ?>" class="btn btn-sm btn-primary" target="_blank"><i class="fa fa-print"></i>&nbsp; TASK TODAY</a>
...
<div class="modal fade" id="modal-tambah-wo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('writeoff/st_add_wo'); ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Debitur</label>
