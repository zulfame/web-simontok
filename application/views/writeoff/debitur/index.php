        ...
        <div class="box box-<?= $site['line']; ?>">
            <div class="box-header with-border bg-<?= $site['color']; ?>">
                <div class="box-tools pull-left">
                    <a href="<?= base_url('writeoff/export_debitur'); ?>" class="btn btn-sm btn-default">EXPORT</a>
                ...
                <div class="box-tools">
                    <form action="<?= base_url('writeoff/debitur') ?>" method="POST">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Last OS</th>
                                    ...
                                    <?php foreach ($debitur as $d) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('writeoff/card/') . $d['kd_credit']; ?>" class="btn-circle btn-sm btn-success" target="_blank"><i class="fa fa-file-text"></i></a>
                                                <a href="<?= base_url('writeoff/card_print/') . $d['kd_credit']; ?>" class="btn-circle btn-sm btn-primary" target="_blank"><i class="fa fa-print"></i></a>
                                            </td>
                                        </tr>
                                        <?php $page; ?>
                                    <?php endforeach; ?>
