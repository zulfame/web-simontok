  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>404</h1>
        <h2>Oops!</h2>
        <p>Halaman yang Anda cari tidak ada. Bagaimana Anda bisa sampai disini adalah sebuah misteri. Tetapi Anda dapat mengklik tombol di bawah ini untuk kembali.
        </p>
        <a href="<?= base_url($d);?>" class="btn green">Back</a>
      </div>
    </div>
  </div>
</main>
