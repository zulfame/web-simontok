    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
			...
			<form method="post" action="<?php echo base_url("index.php/petugas/update"); ?>" enctype="multipart/form-data">
			...
			if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
				...
				echo "<form method='post' action='".base_url("petugas/import_update")."'>";
