              ...
              ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="javascript:;" data-id="<?php echo $data['idprospek'] ?>" data-prospek="<?php echo $data['prospek'] ?>" data-keterangan="<?php echo $data['keterangan'] ?>" data-toggle="modal" data-target="#edit-data" data-toggle="modal" data-target="#ubah-data" class="btn-circle btn-sm btn-success"> <i class="fa fa-eye"></i>
                    </a> &nbsp;
                    <a onclick="return confirm('Apakah anda yakin menghapus?')" class="btn-circle btn-sm btn-danger" href="<?= base_url('prospek/hapus_ksk/'); ?><?= $data['idprospek']; ?>" title="Hapus"><i class="fa fa-trash"></i></a>
                  </td>
                  </td>
                <?php } ?>
            </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">TAMBAH PROSPEK KSK</h4>
      </div>
      <form role="form" method="post" action="<?= base_url('prospek/tambah_ksk'); ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="edit-data">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('prospek/ubah_ksk') ?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
