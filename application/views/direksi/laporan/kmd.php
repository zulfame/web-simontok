        ...
        <div class="box-body">
          <form method="get" action="<?php echo base_url("monitoring/filter/") ?>">
            <div class="form-group pull-left">
              <select class="form-control select2" style="width:200px;" name="wilayah" required="">
          ...
          <div class="form-group pull-right">
            <a href="<?= base_url('monitoring/report'); ?>" class="btn btn-primary"><i class="fa fa-bookmark"></i> TAMPIL SEMUA</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-xs-12">
      <div class="box box-primary">
        <div class="box-header">
          <h3 class="box-title">Laporan Monitoring Debitur</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
